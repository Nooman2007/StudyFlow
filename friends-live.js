...
let liveFriendsReconnectTimer = null;

let liveFriendsReconnectAttempt = 0;

let liveFriendsRecoveryHandlersAttached = false;
    ...
    function scheduleLiveFriendsReconnect() {
    ...
    liveFriendsReconnectAttempt =
        Math.min(
            liveFriendsReconnectAttempt + 1,
            5
        );


    console.log(
        `Reconnecting live friends in ${Math.round(delay / 1000)} seconds...`
    );
    ...
    /*
     * Remove the previous channel before
    ...
    console.log(
        "Starting StudyFlow live friends channel:",
        channelName
    );
            ...
            .subscribe(
                (
                    ...
                    if (
                        ...
                        console.error(
                            "Live Friends Realtime connection lost:",
                            status,
                            error
                        );


                        scheduleLiveFriendsReconnect();
    ...
    /*
     * Update the elapsed live timer every second.
     */
     ...
     * Safety-net refresh.
     *
     * Realtime should normally update the UI
     * instantly, but this catches missed events.
     */
    ...
    /*
     * Recover after network reconnects or
     * returning to the app after sleep.
     */

    if (
        !liveFriendsRecoveryHandlersAttached
    ) {
        ...
        window.addEventListener(
            ...
            () => {
                ...
                console.log(
                    "Network connection restored. Refreshing live friends..."
                );
        ...
        document.addEventListener(
            ...
            () => {
                ...
                if (
                    ...
                    console.log(
                        "StudyFlow became visible. Refreshing live friends..."
                    );
